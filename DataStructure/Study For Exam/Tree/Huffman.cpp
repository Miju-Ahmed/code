...
struct MinH *creatAndBuildMinHeap(char item[], int freq[], int size)
{
...
struct MinHNode *buildHfTree(char item[], int freq[], int size)
{
    ...
    struct MinH *minHeap = creatAndBuildMinHeap(item, freq, size);
...
//Wrapper function
void HufmanCodes(char item[], int freq[], int size)
{
